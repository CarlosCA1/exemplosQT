...
'''
Modificar o programa anterior para que se permita o cambio de forma exclusiva, é dicir que só se poda seleccionar un elemento cando se pulse o QRadioButton,
 mostrando o color de fondo seleccionado. Pola contra, cando se pulsen os controis QCheckBox, os cales poden seleccionarse algún, algúns, ningún ou todos,
  o programa comporarase de forma que: - O haber un seleccionado mostrará a cor especificada no check.
- O haber dous, se mostrará unha cor que sexa a combinación resultante. - O non ter seleccionado ningúnha cor, mostraráse branco.
