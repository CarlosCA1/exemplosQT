...
'''
Deseña unha ferramenta que xere contrasinais aleatorias ao premer un botón. A interface debe incluír: ● Unha etiqueta que diga: “Contrasinal xerado:”
● Un cadro de texto (só de lectura) que amose a contrasinal. ● Un botón “Xerar nova contrasinal”
● Un control deslizante (QSlider) para escoller a lonxitude (de 6 a 20 caracteres). Funcionalidade:
