...
'''
Deseña unha interface que permita ao usuario introducir o seu ano de nacemento nun cadro de texto e, ao premer un botón “Calcular idade”, amose a súa idade nunha etiqueta.
 Validar que a entrada sexa un número. Se o usuario introduce un ano non válido (ex: 3000),
  amosar unha mensaxe de erro nunha etiqueta en vermello. Engade un botón “Limpar” que borre o cadro de texto e a etiqueta de resultado. 
'''
