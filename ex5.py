...
'''
Crea un formulario simple con: ● Cadro de texto para nome ● Cadro de texto para email ● Cadro de texto multiliña (QTextEdit) para mensaxe
● Botón “Enviar” Ao premer “Enviar”, a aplicación debe: ● Comprobar que todos os campos están cubertos.
 ● Se están, amosar unha mensaxe de éxito: “Formulario enviado correctamente.”
  ● Se falta algún campo, amosar: “Faltan datos. Completa todos os campos.” As mensaxes deben amosarse nunha QLabel na parte inferior. 
